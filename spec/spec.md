...
- [x] **Xem giao dịch theo tài khoản:** Click vào tên tài khoản ở Menu Sidebar bên trái **hoặc** trong danh sách tài khoản ở trang `/accounts` thì hiển thị list chi tiết giao dịch tương ứng với tài khoản đó (trang `/transactions` với bộ lọc theo tài khoản).
