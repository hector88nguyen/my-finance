...
1. [ ] **Firebase Authentication:** Đăng nhập/Đăng xuất bằng Email và Password thật thay vì Mock dữ liệu.
2. [ ] **Firestore Database:** Toàn bộ dữ liệu Accounts, Transactions, Categories của mỗi User được lưu trữ độc lập trên Cloud (Firestore).
3. [ ] **Realtime / Async Data:** Giao diện có trạng thái Loading khi gọi dữ liệu từ xa, thay vì xuất hiện ngay lập tức như LocalStorage.
